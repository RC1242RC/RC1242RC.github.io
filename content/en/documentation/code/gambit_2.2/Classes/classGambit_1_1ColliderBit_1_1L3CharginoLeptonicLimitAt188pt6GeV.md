...
|                | Name           |
| -------------- | -------------- |
| virtual [P2](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1p2/) | **[convertPt](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1l3charginoleptoniclimitat188pt6gev/#function-convertpt)**(double x, double y) const<br>Convert a point from pixel units to axis units.  |
| virtual bool | **[isWithinExclusionRegion](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1l3charginoleptoniclimitat188pt6gev/#function-iswithinexclusionregion)**(double x, double y, double mZ) const<br>Check to see if the point is within the exclusion region.  |
| | **[L3CharginoLeptonicLimitAt188pt6GeV](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1l3charginoleptoniclimitat188pt6gev/#function-l3charginoleptoniclimitat188pt6gev)**() |

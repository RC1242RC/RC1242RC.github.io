...
|                | Name           |
| -------------- | -------------- |
| virtual [P2](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1p2/) | **[convertPt](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1alephsmuonlimitat208gev/#function-convertpt)**(double x, double y) const<br>Convert a point from pixel units to axis units.  |
| virtual bool | **[isWithinExclusionRegion](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1alephsmuonlimitat208gev/#function-iswithinexclusionregion)**(double x, double y, double mZ) const<br>Check to see if the point is within the exclusion region.  |
| | **[ALEPHSmuonLimitAt208GeV](/documentation/code/gambit_2.2/classes/classgambit_1_1colliderbit_1_1alephsmuonlimitat208gev/#function-alephsmuonlimitat208gev)**() |

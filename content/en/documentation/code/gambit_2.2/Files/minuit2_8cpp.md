...
|                | Name           |
| -------------- | -------------- |
| void | **[check_node_keys](/documentation/code/gambit_2.2/files/minuit2_8cpp/#function-check-node-keys)**(YAML::Node node, std::vector< std::string > keys)<br>Check that a yaml node does not contain unexpected keys.  |
| double | **[get_node_value](/documentation/code/gambit_2.2/files/minuit2_8cpp/#function-get-node-value)**(YAML::Node node, std::string key, double default_)<br>Get a particular key from a node.  |
| | **[scanner_plugin](/documentation/code/gambit_2.2/files/minuit2_8cpp/#function-scanner-plugin)**(minuit2 , version(6, 23, 01) ) |

...
|                | Name           |
| -------------- | -------------- |
|  | **[OUTPUT](/documentation/code/gambit_2.2/files/specbit__externaltests_8hpp/#define-output)**  |
|  | **[TAGerr](/documentation/code/gambit_2.2/files/specbit__externaltests_8hpp/#define-tagerr)**  |
|  | **[TAGfatal](/documentation/code/gambit_2.2/files/specbit__externaltests_8hpp/#define-tagfatal)**  |
|  | **[TAGeom](/documentation/code/gambit_2.2/files/specbit__externaltests_8hpp/#define-tageom)**  |
...
These functions test various aspects of the Spectrum class and related classes. They are not dependent on any other parts of [Gambit](/documentation/code/gambit_2.2/namespaces/namespacegambit/), so that Spectrum object test code can be compiled and run seperately from [Gambit](/documentation/code/gambit_2.2/namespaces/namespacegambit/), but but also be run from inside [Gambit](/documentation/code/gambit_2.2/namespaces/namespacegambit/).

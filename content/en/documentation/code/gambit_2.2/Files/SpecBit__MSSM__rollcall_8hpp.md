...
|                | Name           |
| -------------- | -------------- |
| | **[BACKEND_REQ](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-backend-req)**(SPheno_MSSMspectrum , (libSPheno) , int , (Spectrum &, const Finputs &) ) |
| | **[DEPENDENCY](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-dependency)**(unimproved_MSSM_spectrum , Spectrum ) |
| | **[ALLOW_MODELS](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-allow-models)**(MSSM63atMGUT , MSSM63atMGUT_mA , MSSM63atQ , MSSM63atQ_mA ) |
| | **[START_FUNCTION](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-start-function)**(map_str_dbl ) |
| int int Farray< fh_real, 1, 2, 1, 5, 1, 3 > Farray< fh_complex, 1, 2, 1, 2, 1, 5, 1, 3 > Farray< fh_real, 1, 6, 1, 5 > Farray< fh_complex, 1, 36, 1, 5 > Farray< fh_real, 1, 2 > Farray< fh_complex, 1, 4 > Farray< fh_complex, 1, 4 > Farray< fh_real, 1, 4 > Farray< fh_complex, 1, 16 > fh_complex fh_real Farray< fh_real, 1, 4 > fh_real & | **[BACKEND_OPTION](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-backend-option)**((FeynHiggs) , (libfeynhiggs) ) |
| int int Farray< fh_real, 1, 2, 1, 5, 1, 3 > Farray< fh_complex, 1, 2, 1, 2, 1, 5, 1, 3 > Farray< fh_real, 1, 6, 1, 5 > Farray< fh_complex, 1, 36, 1, 5 > Farray< fh_real, 1, 2 > Farray< fh_complex, 1, 4 > Farray< fh_complex, 1, 4 > Farray< fh_real, 1, 4 > Farray< fh_complex, 1, 16 > fh_complex fh_real Farray< fh_real, 1, 4 > fh_real int Farray< fh_real, 1, 4 > fh_complex Farray< fh_complex, 1, 3, 1, 3 > Farray< fh_complex, 1, 3, 1, 3 > & | **[BACKEND_REQ](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-backend-req)**(FHUncertainties , (libfeynhiggs) , void , (int &, Farray< fh_real, 1, 4 > &, fh_complex &, Farray< fh_complex, 1, 3, 1, 3 > &, Farray< fh_complex, 1, 3, 1, 3 > &) ) |
| | **[BACKEND_REQ](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-backend-req)**(SUSYHD_MHiggs , () , MReal , (const MList< MReal > &) ) |
| | **[BACKEND_REQ](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#function-backend-req)**(FHSelectUZ , (libfeynhiggs) , void , (int &, int &, int &, int &) ) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| | **[libfeynhiggs](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#variable-libfeynhiggs)**  |
| | **[void](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#variable-void)**  |
| | **[MReal](/documentation/code/gambit_2.2/files/specbit__mssm__rollcall_8hpp/#variable-mreal)**  |

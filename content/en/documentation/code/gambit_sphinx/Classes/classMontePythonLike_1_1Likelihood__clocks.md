...
|                | Name           |
| -------------- | -------------- |
| def | **[__init__](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#function---init--)**(self self, path path, data data, command_line command_line) |
| def | **[loglkl](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#function-loglkl)**(self self, cosmo cosmo, data data) |
| def | **[__init__](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#function---init--)**(self self, path path, data data, command_line command_line) |
| def | **[loglkl](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#function-loglkl)**(self self, cosmo cosmo, data data) |
...
|                | Name           |
| -------------- | -------------- |
| | **[z](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#variable-z)**  |
| | **[Hz](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#variable-hz)**  |
| | **[err](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clocks/#variable-err)**  |

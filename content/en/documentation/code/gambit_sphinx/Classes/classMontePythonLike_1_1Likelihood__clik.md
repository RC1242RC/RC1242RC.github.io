...
|                | Name           |
| -------------- | -------------- |
| def | **[__init__](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#function---init--)**(self self, path path, data data, command_line command_line) |
| def | **[loglkl](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#function-loglkl)**(self self, cosmo cosmo, data data) |
| def | **[__init__](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#function---init--)**(self self, path path, data data, command_line command_line) |
| def | **[loglkl](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#function-loglkl)**(self self, cosmo cosmo, data data) |
...
|                | Name           |
| -------------- | -------------- |
| | **[lensing](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#variable-lensing)**  |
| | **[clik](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#variable-clik)**  |
| | **[l_max](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#variable-l-max)**  |
| | **[nuisance](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#variable-nuisance)**  |
| | **[name](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#variable-name)**  |
| | **[use_nuisance](/documentation/code/gambit_sphinxclasses/classmontepythonlike_1_1likelihood__clik/#variable-use-nuisance)**  |

...
|                | Name           |
| -------------- | -------------- |
| std::vector< std::unordered_set< std::string > > | **[parse_sames](/documentation/code/gambit_sphinxfiles/grid_8cpp/#function-parse-sames)**(const std::vector< std::string > & params) |
| | **[scanner_plugin](/documentation/code/gambit_sphinxfiles/grid_8cpp/#function-scanner-plugin)**(grid , version(1, 0, 0) ) |

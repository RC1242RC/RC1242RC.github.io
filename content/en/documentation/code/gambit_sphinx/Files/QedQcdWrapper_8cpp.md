...
|                | Name           |
| -------------- | -------------- |
|  | **[addtomap_EL](/documentation/code/gambit_sphinxfiles/qedqcdwrapper_8cpp/#define-addtomap-el)**(r, PRODUCT) <br>TODO: wrap using BOSS at some point, i.e. get this from FlexibleSUSY or SoftSUSY.  |
|  | **[addtomap](/documentation/code/gambit_sphinxfiles/qedqcdwrapper_8cpp/#define-addtomap)**(__KEYS, FPTR)  |

...
|                | Name           |
| -------------- | -------------- |
| struct | **[Settings](/documentation/code/gambit_2/classes/structsettings/)**  |
...
|                | Name           |
| -------------- | -------------- |
| void | **[run_polychord](/documentation/code/gambit_2/files/polychord_8hpp/#function-run-polychord)**(double(*)(double *, int, double *, int) loglikelihood, void(*)(int, int, int, double *, double *, double *, double, double) dumper, [Settings](/documentation/code/gambit_2/classes/structsettings/) ) |

...
|                | Name           |
| -------------- | -------------- |
|  | **[NS_SEP](/documentation/code/darkbit/files/backends_2include_2gambit_2backends_2ini__functions_8hpp/#define-ns-sep)** <br>Define the separator to use instead of "::" when macros get gnarly.  |

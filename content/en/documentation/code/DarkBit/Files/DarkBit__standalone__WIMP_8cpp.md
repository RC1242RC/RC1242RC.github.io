...
|                | Name           |
| -------------- | -------------- |
| | **[QUICK_FUNCTION](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#function-quick-function)**(DarkBit , TH_ProcessCatalog , OLD_CAPABILITY , TH_ProcessCatalog_WIMP , TH_ProcessCatalog , () , (mwimp, double) ) |
| std::string void | **[dump_array_to_file](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#function-dump-array-to-file)**(const std::string & filename, const boost::multi_array< double, 2 > & a, const std::vector< double > & x, const std::vector< double > & y) |
| void | **[dumpSpectrum](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#function-dumpspectrum)**(std::vector< std::string > filenames, double mWIMP, double sv, std::vector< double > brList, double mPhi =-1) |
| int | **[main](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#function-main)**(int argc, char * argv[]) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| | **[WIMP_properties](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#variable-wimp-properties)**  |
| | **[OLD_CAPABILITY](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#variable-old-capability)**  |
| | **[WIMP_properties_WIMP](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#variable-wimp-properties-wimp)**  |
| | **[WIMPprops](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#variable-wimpprops)**  |
| | **[DarkMatter_ID](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#variable-darkmatter-id)**  |
| | **[DarkMatterConj_ID](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#variable-darkmatterconj-id)**  |

## Defines

|                | Name           |
| -------------- | -------------- |
|  | **[addParticle](/documentation/code/darkbit/files/darkbit__standalone__wimp_8cpp/#define-addparticle)**(Name, Mass, spinX2)  |

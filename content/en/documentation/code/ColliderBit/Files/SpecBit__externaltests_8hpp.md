...
|                | Name           |
| -------------- | -------------- |
|  | **[OUTPUT](/documentation/code/colliderbit/files/specbit__externaltests_8hpp/#define-output)**  |
|  | **[TAGerr](/documentation/code/colliderbit/files/specbit__externaltests_8hpp/#define-tagerr)**  |
|  | **[TAGfatal](/documentation/code/colliderbit/files/specbit__externaltests_8hpp/#define-tagfatal)**  |
|  | **[TAGeom](/documentation/code/colliderbit/files/specbit__externaltests_8hpp/#define-tageom)**  |
...
These functions test various aspects of the Spectrum class and related classes. They are not dependent on any other parts of [Gambit](/documentation/code/colliderbit/namespaces/namespacegambit/), so that Spectrum object test code can be compiled and run seperately from [Gambit](/documentation/code/colliderbit/namespaces/namespacegambit/), but but also be run from inside [Gambit](/documentation/code/colliderbit/namespaces/namespacegambit/).

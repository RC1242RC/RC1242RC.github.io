...
|  | **[LOAD_FACTORIES_FOR_TYPE](/documentation/code/colliderbit/files/backend__macros_8hpp/#define-load-factories-for-type)**(r, data, elem) <br>Load all factory functions for a given type.  |

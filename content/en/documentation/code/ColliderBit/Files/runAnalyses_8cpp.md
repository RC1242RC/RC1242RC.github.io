...
|                | Name           |
| -------------- | -------------- |
|  | **[DEBUG_PREFIX](/documentation/code/colliderbit/files/runanalyses_8cpp/#define-debug-prefix)**  |
|  | **[RUN_ANALYSES](/documentation/code/colliderbit/files/runanalyses_8cpp/#define-run-analyses)**(NAME, EXPERIMENT, SMEARED_EVENT_DEP) <br>Run all analyses for EXPERIMENT.  |

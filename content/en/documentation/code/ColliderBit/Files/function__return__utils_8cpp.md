...
|                | Name           |
| -------------- | -------------- |
| template <typename U ,typename V \> <br>U * | **[pointer_returner](/documentation/code/colliderbit/files/function__return__utils_8cpp/#function-pointer-returner)**(V * ptr) |
| template <typename U ,typename V \> <br>U & | **[reference_returner](/documentation/code/colliderbit/files/function__return__utils_8cpp/#function-reference-returner)**(V * ptr) |
| template <typename U ,typename V \> <br>U & | **[reference_returner](/documentation/code/colliderbit/files/function__return__utils_8cpp/#function-reference-returner)**(const V * ptr) |

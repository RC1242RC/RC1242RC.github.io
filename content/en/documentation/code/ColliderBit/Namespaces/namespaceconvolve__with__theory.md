...
|                | Name           |
| -------------- | -------------- |
| def | **[convolve](/documentation/code/colliderbit/namespaces/namespaceconvolve__with__theory/#function-convolve)**(file_name file_name, frac_error frac_error =0.1, min_ min_ =0., max_ max_ =1., log_normal log_normal =True) |

## Attributes

|                | Name           |
| -------------- | -------------- |
| | **[FILE_NAME](/documentation/code/colliderbit/namespaces/namespaceconvolve__with__theory/#variable-file-name)**  |
| | **[ARGS](/documentation/code/colliderbit/namespaces/namespaceconvolve__with__theory/#variable-args)**  |

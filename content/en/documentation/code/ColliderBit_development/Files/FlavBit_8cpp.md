...
|                | Name           |
| -------------- | -------------- |
|  | **[THE_REST](/documentation/code/colliderbit_development/files/flavbit_8cpp/#define-the-rest)**(bins)  |
|  | **[SI_SINGLE_PREDICTION_FUNCTION](/documentation/code/colliderbit_development/files/flavbit_8cpp/#define-si-single-prediction-function)**(name)  |
|  | **[SI_SINGLE_PREDICTION_FUNCTION_BINS](/documentation/code/colliderbit_development/files/flavbit_8cpp/#define-si-single-prediction-function-bins)**(name, bins)  |
|  | **[SI_MULTI_PREDICTION_FUNCTION](/documentation/code/colliderbit_development/files/flavbit_8cpp/#define-si-multi-prediction-function)**(name)  |
|  | **[SI_MULTI_PREDICTION_FUNCTION_BINS](/documentation/code/colliderbit_development/files/flavbit_8cpp/#define-si-multi-prediction-function-bins)**(name, bins, exp)  |
|  | **[HEPLIKE_GAUSSIAN_1D_LIKELIHOOD](/documentation/code/colliderbit_development/files/flavbit_8cpp/#define-heplike-gaussian-1d-likelihood)**(name, file) <br>HEPLike single-observable likelihood.  |

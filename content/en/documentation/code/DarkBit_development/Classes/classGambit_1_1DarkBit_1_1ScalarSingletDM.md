...
|                | Name           |
| -------------- | -------------- |
| | **[ScalarSingletDM](/documentation/code/classes/classgambit_1_1darkbit_1_1scalarsingletdm/#function-scalarsingletdm)**(TH_ProcessCatalog *const catalog, double gammaH, double vev, double alpha_strong, double vSigma_s)<br>Initialize SingletDM object (branching ratios etc)  |

...
|                | Name           |
| -------------- | -------------- |
| | **[WIMP_EFT_DM](/documentation/code/classes/classgambit_1_1darkbit_1_1wimp__eft__dm/#function-wimp-eft-dm)**(TH_ProcessCatalog *const catalog)<br>Initialize object (branching ratios etc)  |

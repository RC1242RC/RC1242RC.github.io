...
<table>
  <tr>
    <td><img src="{{ .Site.BaseURL}}/images/Fruzsina.png" alt="Fruzsina Agocs" style="width:100px">
        <br><a href="https://fruzsinaagocs.github.io">Fruzsina Agocs</a>
    </td>
   <td><img src="{{ .Site.BaseURL}}/images/Viktor.jpg" alt="Viktor Ananiev" style="width:100px">
        <br><a href="https://www.mn.uio.no/fysikk/english/people/aca/viktoana/index.html">Viktor Ananiev</a>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Peter.jpg" alt="Peter Athron" style="width:100px">
        <br><a href="https://research.monash.edu/en/persons/peter-athron">Peter Athron</a>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Csaba.jfif" alt="Csaba Balazs" style="width:100px">
        <br><a href="https://research.monash.edu/en/persons/csaba-balazs">Csaba Balazs</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Ankit.jpg" alt="Ankit Beniwal" style="width:115px">
       <br><a href="https://cp3.irmp.ucl.ac.be/public/member/566/en">Ankit Beniwal</a><br>
    </td>
  </tr>
  <tr>
    <td><img src="{{ .Site.BaseURL}}/images/torsten.jpg" alt="Torsten Bringmann" style="width:82px">
        <br><a href="https://www.mn.uio.no/fysikk/english/people/aca/troms/">Torsten Bringmann</a>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/andyb.jpg" alt="Andy Buckley" style="width:110px">
    ...
    <td><img src="{{ .Site.BaseURL}}/images/Chris_Chang.png" alt="Christopher Chang" style="width:100px">
         <br>Christopher Chang<br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Cornell.png" alt="Jonathan Cornell" style="width:100px">
  ...
  <tr>
    ...
    <td><img src="{{ .Site.BaseURL}}/images/Timon.png" alt="Timon Emken" style="width:115px">
    ...
    <td><img src="{{ .Site.BaseURL}}/images/Tomas.jpg" alt="Tomas Gonzalo" style="width:100px">
         <br><a href="https://research.monash.edu/en/persons/tomas-gonzalo-velasco">Tomas Gonzalo</a>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Philip_Grace.jpg" alt="Philip Grace" style="width:120px">
         <br>Philip Grace<br>
    </td>
  </tr>
  <tr>
    <td><img src="{{ .Site.BaseURL}}/images/WillHandley.jpg" alt="Will Handley" style="width:90px">
      <br><a href="https://www.kicc.cam.ac.uk/directory/wh260">Will Handley</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Paul_Jackson.jpg" alt="Paul Jackson" style="width:120px">
        <br><a href="https://researchers.adelaide.edu.au/profile/p.jackson">Paul Jackson</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/felix.jpg" alt="Felix Kahlhoefer" style="width:90px">
    ...
    <td><img src="{{ .Site.BaseURL}}/images/Anders.jpg" alt="Anders Kvellestad" style="width:90px">
        <br><a href="https://www.mn.uio.no/fysikk/english/people/aca/anderkve/index.html">Anders Kvellestad</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Lucente.jpeg" alt="Michele Lucente" style="width:100px">
  ...
  <tr>
    <td><img src="{{ .Site.BaseURL}}/images/Nazila.jpg" alt="Nazila Mahmoudi" style="width:105px">
      <br>Nazila Mahmoudi<br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Holly.jpeg" alt="Holly Pacey" style="width:120px">
        <br><a href="https://www.hep.phy.cam.ac.uk/~hp341/">Holly Pacey</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Are.jpg" alt="Are Raklev" style="width:85px">
        <br><a href="https://www.mn.uio.no/fysikk/personer/vit/ahye/">Are Raklev</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Andre.jpg" alt="Andre Scaffidi" style="width:115px">
        <br>Andre Scaffidi<br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Pat.jpg" alt="Pat Scott" style="width:100px">
        <br><a href="http://researchers.uq.edu.au/researcher/24834">Pat Scott</a><br>
    </td>
  </tr>
  <tr>
    <td><img src="{{ .Site.BaseURL}}/images/Cristian_Sierra.jpeg" alt="Cristian Sierra" style="width:120px">
        <br><a href="https://github.com/cristianfsierraf">Cristian Sierra</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Patrick_Stoecker.jpg" alt="Patrick Stöecker" style="width:105px">
    ...
    <td><img src="{{ .Site.BaseURL}}/images/wei.jpg" alt="Wei Su" style="width:120px">
      <br><a href="http://inspirehep.net/author/profile/W.Su.2">Wei Su</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Jeriek.jpg" alt="Jeriek Van den Abeele" style="width:100px">
      <br><a href="https://jeriek.github.io">Jeriek Van den Abeele</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/aaronbw.jpeg" alt="Aaron Vincent" style="width:105px">
        <br><a href="https://www.physics.queensu.ca/facultysites/vincent/">Aaron Vincent</a><br>
    </td>
  </tr>
  <tr>
    <td><img src="{{ .Site.BaseURL}}/images/Martin.jpg" alt="Martin White" style="width:98px">
        <br><a href="https://researchers.adelaide.edu.au/profile/martin.white">Martin White</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Yongcheng_Wu.jpeg" alt="Yongcheng Wu" style="width:120px">
        <br><a href="https://github.com/ycwu1030">Yongcheng Wu</a><br>
    </td>
    <td><img src="{{ .Site.BaseURL}}/images/Yang_Zhang.jpeg" alt="Yang Zhang" style="width:120px">
